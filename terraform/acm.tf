...
resource "aws_acm_certificate" "subscription_intake_api_certificate" {
  ...
  tags = {
    Name = "subscription_intake_api_certificate"
  }
  lifecycle {
    create_before_destroy = true
  }
...
resource "aws_acm_certificate_validation" "subscription_intake_api_certificate_validation" {
